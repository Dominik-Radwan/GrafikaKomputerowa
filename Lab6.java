 ...
 */
public class Lab5 extends GLJPanel implements GLEventListener  {
	...
	/**
	 * Constructor for class Lab5, sets the preferred size and configures event listeners
	 */
	public Lab5() {
	...
	public void display(GLAutoDrawable drawable) {    
		...
		Polygon_and_Triangle(gl2,10,5,9);
		gl2.glPopMatrix();
	...
	public void Podstawa (GL2 gl2,int n , int r)
	{
		...
		{	
			...
			gl2.glMaterialfv(gl2.GL_FRONT_AND_BACK,gl2.GL_AMBIENT_AND_DIFFUSE,materials[5],1);
	...
	public void Polygon_and_Triangle (GL2 gl2,int n , int r, int h)
	{
	    ...
	    for (int i=0;i<=n;i++)
	    {
	    	...
	    	gl2.glBegin(GL2.GL_POLYGON);	
	    	gl2.glMaterialfv(gl2.GL_FRONT_AND_BACK,gl2.GL_AMBIENT_AND_DIFFUSE,materials[5],2);
			gl2.glVertex3d((double)(r*Math.cos(i*2*Math.PI/n)),1, (double)(r*Math.sin(i*2*Math.PI/n))); 
			gl2.glMaterialfv(gl2.GL_FRONT_AND_BACK,gl2.GL_AMBIENT_AND_DIFFUSE,materials[5],4);
			gl2.glVertex3d(0, h, 0);
			i++;
			gl2.glMaterialfv(gl2.GL_FRONT_AND_BACK,gl2.GL_AMBIENT_AND_DIFFUSE,materials[5],8);
			gl2.glVertex3d((double)(r*Math.cos(i*2*Math.PI/n)),1,(double)(r*Math.sin(i*2*Math.PI/n)));
			i--;
		    gl2.glEnd();
	    }
	...
	public void init(GLAutoDrawable drawable) {
		...
		float light[] = { 1.0f, 1.9f, 1.0f, 1.9f };
	...
	private class MouseHandler extends MouseAdapter {
		...
		public void mousePressed(MouseEvent evt) {
			...
			prevX = evt.getX();
			dragging = true;
			Lab5.this.addMouseMotionListener(this);
		}
		public void mouseReleased(MouseEvent evt) {
			dragging = false;
			Lab5.this.removeMouseMotionListener(this);
		}
